...
import Model.San;
import DBconnect.SanController;
...
public class SanView extends MainMenuView {
    ...
    private List<San> listSan = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        controller.setButtonListener(AddBtn, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                San s = new San(TenSan, LoaiSan, GiaSan);
                controller.addsan(s);
        ...
        controller.setButtonListener(SearchBtn, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                List<San> searchResult = new ArrayList<>();
        ...
        controller.setButtonListener(ExportBtn, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                List<San> list1 = new SanController().getSanList();
                //
                if (list1 != null) {
